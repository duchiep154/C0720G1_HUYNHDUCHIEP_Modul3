    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <a href="/view"><h1 style="color: red">Product List</h1></a>
                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modelCreate">
                            Create Product
                        </button>
                                                <p>
                                                    <a href="/view?action=create"><h3>Create New Product</h3></a>
                                                </p>
                    </div>
                    <div class="col-sm-4">
            ...
            <table id="tableProduct" class="table table-striped table-bordered table-hover" style="width:100%">
                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#modeldetail" class="detail"
                               title="Detail" onclick="detail('${product.id}','${product.name}','${product.price}','${product.quantity}','${product.color}','${product.description}','${product.idCategory}')"
                               data-toggle="tooltip"><i class="fa fa-eye" style="color: #0000ff"></i></a>

                            <a data-toggle="modal" data-target="#modelEdit"  href="#"
                               onclick="editProductId('${product.id}','${product.name}','${product.price}','${product.quantity}','${product.color}','${product.description}','${product.idCategory}')" class="edit"
                               title="Edit"
                               data-toggle="tooltip" >
                                <i class="material-icons">&#xE254;</i>
                            </a>
...
<%--                    </div>--%>
                    ...
                    <div>
                        ...
                        <span>
                             <a href="/view" class="btn btn-info back">Back</a>
                            </span>
                    </div>
...
<form method="post" action="/view" id="formSearchProduct">
...
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modeldetail">
    Launch
</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group has-success">
                            <label for="name">Name :</label>
                            <input type="text" class="form-control" name="name" id="nameDetail" value="${product.name}" readonly/>
                        </div>

                        <div class="form-group has-warning">
                            <label for="price">Price :</label>
                            <input type="text" class="form-control" name="price" id="priceDetail" value="${product.price}" readonly/>
                            <p>${messagePrice}</p>
                        </div>

                        <div class="form-group has-error">
                            <label for="quantity">Quantity :</label>
                            <input type="text" class="form-control" name="quantity" id="quantityDetail" value="${product.quantity}" readonly/>
                            <p>${messageQuantity}</p>
                        </div>

                        <div class="form-group has-success">
                            <label for="color">Color :</label>
                            <input type="text" class="form-control" name="color" id="colorDetail" value="${product.color}" readonly/>
                        </div>

                        <div class="form-group has-warning">
                            <label for="description">Description :</label>
                            <input type="text" class="form-control" name="description" id="descriptionDetail" value="${product.description}" readonly/>
                        </div>
...
<script>
    ...
    function detail(id,name,price,quantity,color,description,idCategory) {
        console.log(id,name,price,quantity,color,description,idCategory);
        document.getElementById("id").value=id;
        document.getElementById("nameDetail").value=name;
        document.getElementById("priceDetail").value=price;
        document.getElementById("quantityDetail").value=quantity;
        document.getElementById("colorDetail").value=color;
