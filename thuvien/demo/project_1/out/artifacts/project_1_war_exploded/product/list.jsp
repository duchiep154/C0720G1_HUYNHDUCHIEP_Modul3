...
<div class="container">
    ...
    <div class="row">
        <div class="col-4">
            <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modalCreate">Create new Product</a>
        </div>
        <div class="form-group col-8">
                <form class="row" action="/products" method="get">
                    <button style="margin-left: 250px" type="submit" class="btn btn-primary col-2" name="action" value="find">Seacrh</button>
