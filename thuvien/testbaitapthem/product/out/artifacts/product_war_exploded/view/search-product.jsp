                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td>
                            <a href="#" class="edit"
                               title="Edit"
                               onclick="editProductId('${product.id}','${product.name}','${product.price}','${product.quantity}','${product.color}','${product.color}','${product.description}','${product.idCategory}')"  data-toggle="modal" data-target="#modelEdit"><i
...
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modelSearchDelete">
    Launch
</button>
            ...
            <div class="modal-body">
                <form action="/product" method="post">
                    ...
                    <div class="form-group has-error">
                        ...
                        <p><c:out value="${messageQuantity}"></p>
                    </div>
