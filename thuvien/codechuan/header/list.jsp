...
<%--&lt;%&ndash;                        <h1 style="color: red">Product List</h1>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <a href="/home?action=showCreate"><h3>Create New Product</h3></a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
            ...
            <table id="tableProduct" class="table table-striped table-hover table-bordered" style="width: 100%">
                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td>
                            <a href="/home?action=showDetail&id=${product.id}" class="detail"
                               title="Detail"
