...
public class TheMuonSachRepositoryImpl implements TheMuonSachRepository {
    ...
    private static final String MUON_SACH = "UPDATE sach SET sach_so_luong = sach_so_luong - 1 where sach_id = ?; ";

    private static final String DELETE = "DELETE FROM the_muon_sach WHERE the_muon_sach_id = ?";
    ...
    public boolean add(TheMuonSach theMuonSach) {
        ...
        try {
            ...
            if (preparedStatement.executeUpdate() > 0) {
                flag = true;
                preparedStatement = connection.prepareStatement(MUON_SACH);
    ...
    @Override
    public boolean traSach(String id) {
        Connection connection = DBConnection.getConnection();
        PreparedStatement preparedStatement = null;
        boolean flag = false;
