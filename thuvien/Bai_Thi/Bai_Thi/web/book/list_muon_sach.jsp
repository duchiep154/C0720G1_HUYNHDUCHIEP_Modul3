                ...
                <form method="get" action="/books">
                    ...
                    <td>
                        <c:forEach items="${sachList}" var="sach">
                            ${theMuonSach.sachId == sach.id ? sach.name : ""}
                        </c:forEach>
                    </td>
                    <td>
                        <c:forEach items="${sachList}" var="sach">
                            ${theMuonSach.sachId == sach.id ? sach.tacGia : ""}
                        </c:forEach>
                    </td>
                    <td>
                        <c:forEach items="${hocSinhList}" var="hocSinh">
                            ${theMuonSach.hocSinhId == hocSinh.id ? hocSinh.name : ""}
                        </c:forEach>
                    </td>
                    <td>
                        <c:forEach items="${hocSinhList}" var="hocSinh">
                            ${theMuonSach.hocSinhId == hocSinh.id ? hocSinh.lop : ""}
                        </c:forEach>
                    </td>
                    <td>
                    ...
                    <td>
                        <a href="/books" onclick="onTraSach('${theMuonSach.id}')" class="btn btn-outline-danger" data-toggle="modal"
